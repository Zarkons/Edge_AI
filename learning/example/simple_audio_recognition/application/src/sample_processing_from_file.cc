...
namespace
{
    ...
    std::string getWavFilesPath()
    {
        ...
        {
            return (fs::path(workspace_dir) / "learning/example/simple_audio_recognition/train/build_dir/data/mini_speech_commands_extracted/mini_speech_commands").string();
        }

        return "learning/example/simple_audio_recognition/train/build_dir/data/mini_speech_commands_extracted/mini_speech_commands";
    }
