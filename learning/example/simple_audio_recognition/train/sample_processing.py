...
def get_build_dir():
    ...
    if workspace_dir:
        actual_save_dir = os.path.join(workspace_dir, "learning/example/simple_audio_recognition/train/_build_dir/")
    else:
        ...
        actual_save_dir = os.path.join(repo_root, "learning/example/simple_audio_recognition/train/_build_dir/")
