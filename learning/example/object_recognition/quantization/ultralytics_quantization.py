...
"""
    ...
    if workspace_dir:
        final_destination_tflite = pathlib.Path(workspace_dir) / "learning/example/object_recognition/_build_dir/models/yolov8_int8.tflite"
        final_destination_pb = pathlib.Path(workspace_dir) / "learning/example/object_recognition/_build_dir/models/yolov8_int8_saved_model.pb"
        final_destination_tflite = pathlib.Path(workspace_dir) / "learning/example/object_recognition/_build_dir/models/yolov8_int8_quantized.tflite"
