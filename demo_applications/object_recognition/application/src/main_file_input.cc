...
int main(int argc, char *argv[])
{
    ...
    std::string model_token = "demo_applications/object_recognition/_build_dir/models/yolov8n_fp32.onnx";
    ...
    {
        model_token = "demo_applications/object_recognition/_build_dir/models/yolov8n_int8.onnx";
    }
